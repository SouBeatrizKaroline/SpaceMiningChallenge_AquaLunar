...
[Comparação de recursos](./docs/recursos.md) · [Missão Aurora Sul com evidências verificáveis](./docs/missao-aurora-sul.md) · [Dossiê de dados reais de Shackleton](./docs/dados-reais-shackleton.md)
