...
[Comparação de recursos](./docs/recursos.md) · [Missão Aurora Sul com evidências verificáveis](./docs/missao-aurora-sul.md) · [Dossiê de dados reais de Shackleton](./docs/dados-reais-shackleton.md) · [Comparação de regiões polares](./docs/comparacao-regioes-polares.md)
...
O [registro da Missão Aurora Sul](./docs/missao-aurora-sul.md) reúne a decisão, os instrumentos, o payload, a energia, os riscos ambientais e a lista de verificações que a equipe precisa concluir antes da entrega. O [orçamento de referência](./docs/orcamento-referencia-aurora-sul.md) detalha a massa, a energia e as capturas necessárias.
