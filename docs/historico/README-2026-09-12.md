> Registro histórico do README anterior à consolidação das anotações de 12/09/2026. Preserva o conteúdo e as decisões daquela versão. A prioridade atual de uso está no [README principal](../../README.md) e nos [estudos técnicos](../estudos/README.md). Os registros de validação abaixo pertencem à versão anterior.
...
[Abrir laboratório](https://soubeatrizkaroline.github.io/SpaceMiningChallenge_AquaLunar/) · [Método](../desenvolvimento/metodologia.md) · [Fontes](../referencias/fontes.md) · [Contribuir](../../CONTRIBUTING.md)

**MVP funcional v0.1.0.** [Aplicação ao desafio](../missao/desafio.md) · [Integrações e dados externos](../desenvolvimento/integracoes.md) · [Validação e limites](../desenvolvimento/validacao.md) · [Status do desafio](../missao/status-desafio.md)

[Comparação de recursos](../pesquisa/recursos.md) · [Missão Aurora Sul com evidências verificáveis](../missao/missao-aurora-sul.md) · [Dossiê de dados reais de Shackleton](../pesquisa/dados-reais-shackleton.md) · [Comparação de regiões polares](../pesquisa/comparacao-regioes-polares.md)

![Qualidade](https://github.com/SouBeatrizKaroline/SpaceMiningChallenge_AquaLunar/actions/workflows/ci.yml/badge.svg)

![Interface do AQUA Lunar com corte conceitual e controles de material](../imagens/preview-laboratorio.png)
...
O [registro da Missão Aurora Sul](../missao/missao-aurora-sul.md) reúne a decisão, os instrumentos, o payload, a energia, os riscos ambientais e a lista de verificações que a equipe precisa concluir antes da entrega. O [orçamento de referência](../missao/orcamento-referencia-aurora-sul.md) detalha a massa, a energia e as capturas necessárias.
...
Os registros complementares do QuickMap estão em [consulta 1](https://bit.ly/3Vr5I3e) e [consulta 2](https://bit.ly/3V6I0sX). A [captura das camadas usadas](../evidencias/quickmap-diviner-psr-lola.png) mostra a configuração com Diviner, PSRs e LOLA.

A [galeria de evidências complementares](../evidencias/README.md) preserva todas as capturas feitas durante a consulta, com indicação do que cada camada demonstra e de seus limites. A [interpretação das capturas](../evidencias/interpretacao-capturas.md) detalha o que é evidência de terreno, sombra ou temperatura, e o que não pode ser afirmado a partir das imagens.

As [pesquisas, anotações e percepções da equipe](https://canva.link/e5xxa0ukj24cs3o) e o [espaço complementar de pesquisa](https://canva.link/rt0dr4u0cxwmnmn) estão reunidos no Canva. A [lista completa de links compartilhados](../referencias/links-compartilhados.md) separa portais científicos de materiais de contexto.
...
Consulte [equações, coeficientes e limites](../desenvolvimento/metodologia.md).
